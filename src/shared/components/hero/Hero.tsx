...
const Hero = () => {
    ...
    return (
        <section className="relative bg-[#0517C7] overflow-hidden flex flex-col">
            ...
            <div className="grow flex items-center pt-4 lg:pt-8 pb-8 lg:pb-12">
                <div className="container relative z-10 px-4">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
                        {/* Left Content */}
                        <div className="w-full lg:w-1/2 flex flex-col gap-8 lg:gap-10 relative z-20">
                            <motion.h1
                        ...
                        <motion.div
                            ...
                            className="w-full lg:w-[70%] lg:-ml-[8%] lg:-mr-[12%] lg:-mt-16 relative z-10"
                        >
